...
export default function StatsCounters({
  ...
  return (
    <section
      ref={ref}
      className="border-y border-black/5 bg-surface-alt px-6 py-4 md:px-8"
    >
      {(dict.titleLine1 || dict.titleLine2) && (
        <motion.div
      ...
      <div
        className={[
          "mx-auto grid max-w-4xl divide-x divide-black/5",
          (
            {
              1: "grid-cols-1",
              2: "grid-cols-2",
          ...
          )[dict.items.length] ?? "grid-cols-2 sm:grid-cols-4",
        ].join(" ")}
      >
